...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percentage = float(county_vote_count) / float(total_county_votes) * 100
        county_results = (
    ...
    county_vote_summary = (
        ...
        f"Total Votes in County: {largest_county_vote:,}\n"
        f"County Vote Percentage of Total: {largest_county_percentage:.1f}%\n"
        f"-------------------------\n")
    print(county_vote_summary, end="")
